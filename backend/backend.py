...
def generate_meditation_text(user_name,goal,language,   preferences = preferences):
    ...
    prompt = f"Create a personalized meditation script for {user_name} with a goal of {goal} in {language} considering the following preferences: {preferences} in less than 2500 characters"
